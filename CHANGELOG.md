...
- **เมนู "ผู้ติดต่อ (HR)"** ของเจ้าหน้าที่ (`/admin/contacts`) — ดู/เพิ่ม/แก้/ลบ ผู้ติดต่อทุกบริษัท แสดงจำนวนนักศึกษาที่เลือก · ลบคนที่มีนักศึกษาเลือกอยู่ได้ แต่เตือนจำนวนก่อน
