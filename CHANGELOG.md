...
## [2026-09-26] feat: ผู้ติดต่อ (HR) แทนพี่เลี้ยง

### Added
- **ผู้ติดต่อ (HR) ของบริษัท** — ตารางใหม่ `CompanyContact` (ชื่อ นามสกุล ตำแหน่ง ทีม/แผนก อีเมล เบอร์) บริษัทหนึ่งมีได้หลายคน ผูกกับคำร้องของนักศึกษาแต่ละคน (เลือกได้หลายคน)
  - ผู้ติดต่อเดิมของบริษัท (ช่อง "ผู้ติดต่อ" ในข้อมูลบริษัท) ถูกย้ายเป็นผู้ติดต่อคนแรกให้อัตโนมัติ · ช่องเดิมยังเก็บไว้เป็นค่าสำรอง
  - migration `20260926100000_add_company_contacts` (ต้อง `migrate deploy` + `generate` ตอน deploy)
- **เมนู "ผู้ติดต่อ (HR)"** ของเจ้าหน้าที่ (`/admin/contacts`) — ดู/เพิ่ม/แก้/ลบ ผู้ติดต่อทุกบริษัท แสดงจำนวนนักศึกษาที่เลือก · ลบคนที่มีนักศึกษาเลือกอยู่ได้ แต่เตือนจำนวนก่อน · นักศึกษาลบผู้ติดต่อที่นักศึกษาคนอื่นเลือกอยู่ไม่ได้ (ให้แก้ไขแทน — กฎเดียวกับการลบบริษัท)
- บันทึกการใช้งาน: เพิ่ม/แก้ไข/ลบผู้ติดต่อบริษัท

### Changed
- **หน้าข้อมูลนักศึกษา** — "เลือกบริษัทและพี่เลี้ยง" → **"เลือกบริษัทและผู้ติดต่อ (HR)"** · ค้นหา/เลือกผู้ติดต่อ และกด "+ เพิ่มผู้ติดต่อ" ได้ในหน้าเดียว · เปลี่ยนบริษัทแล้วผู้ติดต่อที่เลือกไว้ถูกล้าง
- **ต้องมีผู้ติดต่ออย่างน้อย 1 คนก่อนยื่นคำร้อง** (ตรวจทั้งหน้าเว็บและหลังบ้าน) · คำร้องที่ยื่นไปแล้วไม่กระทบ
- **พี่เลี้ยงกรอกในแบบฟอร์ม T002 ข้อ 3 ที่เดียว** — หน้าข้อมูลนักศึกษา/หน้าบริษัทของนักศึกษาแสดงพี่เลี้ยงอย่างเดียว (เจ้าหน้าที่ยังแก้ไขพี่เลี้ยงได้)
- **หน้าบริษัท** (นักศึกษาและเจ้าหน้าที่) จัดการผู้ติดต่อ · หลังเพิ่มบริษัทใหม่ถามให้เพิ่มผู้ติดต่อ
- **หน้ายื่นคำร้อง** แสดงผู้ติดต่อ (ไม่มี → กล่องเตือนพร้อมลิงก์) · PDF คำร้องช่อง "ผู้ประสานงาน" ใช้ผู้ติดต่อ (เดิมใช้พี่เลี้ยงคนแรก)
- **หน้าข้อมูลนักศึกษาของเจ้าหน้าที่/อาจารย์** แสดง "ผู้ติดต่อ (HR)" ใต้อาจารย์ที่ปรึกษา และในแท็บบริษัท
- **หน้าตรวจคำร้อง** แสดงผู้ติดต่อ + ป้าย "⚠️ ยังไม่มีผู้ติดต่อ" สำหรับคำร้องเก่า (เตือนอย่างเดียว ไม่ขวางการตรวจ)
- **หนังสือขอความอนุเคราะห์ / ส่งตัว / นิเทศ** (PDF และ Word) ช่อง "เรียน" ใช้ผู้ติดต่อของคำร้อง → ถ้าไม่มีใช้ผู้ติดต่อเดิมของบริษัท · หน้าต่างออกหนังสือแสดงว่าจะ "เรียน" ใคร
- แก้ไขข้อมูลบริษัทแล้วเปิดรายละเอียด ผู้ติดต่อและพี่เลี้ยงหายไปจนกว่าจะรีโหลดหน้า (ทั้งหน้าเจ้าหน้าที่และนักศึกษา) — API แก้ไขบริษัทไม่ได้ส่งพี่เลี้ยง/ผู้ติดต่อกลับมา
- ลำดับผู้ติดต่อคงที่ (ตามเวลาที่เพิ่ม) — ผู้ติดต่อ "คนแรก" ที่เป็นผู้รับหนังสือจึงไม่สลับไปมา
- **ไฟล์ Excel** เพิ่มคอลัมน์ "ผู้ติดต่อ (HR)" (ชื่อ · ตำแหน่ง · เบอร์ · อีเมล)

### Fixed
- ตำแหน่งผู้รับไม่เคยขึ้นในหนังสือทั้ง 3 ฉบับ และหนังสือขอความอนุเคราะห์ขึ้น "เรียน กรรมการผู้จัดการ" ทุกฉบับ — โค้ดอ่านชื่อช่องที่ไม่มีอยู่จริง (`contactPersonName` / `contactPersonPosition`)
- หน้านักศึกษาของอาจารย์ (ที่ไม่ใช่อาจารย์สหกิจ) ขึ้น "ยังไม่ระบุพี่เลี้ยง" เสมอ — `/api/teacher/my-students` ไม่ได้ส่งข้อมูลพี่เลี้ยงมา

### Tests
- unit 746/746 · e2e 103/103 (รวมเทสต์ผู้รับหนังสือ + หน้าผู้ติดต่อ) · ตรวจ 48 หน้าไม่มี error · tsc คงที่ 23
- ทดสอบในเบราว์เซอร์: หน้าข้อมูลนักศึกษา 10/10 · หน้าบริษัท/ยื่นคำร้อง/PDF 8/8 · เมนูผู้ติดต่อ/ป้าย/Excel 14/14 · หนังสือ 3 ฉบับ 7/7

## [2026-09-26] refactor: เปลี่ยนชื่อเรียก สาขา → หลักสูตร · หลักสูตร → รูปแบบการศึกษา

### Changed
- **"สาขา" / "สาขาวิชา" → "หลักสูตร"** ทุกหน้าจอ: ตัวกรอง หัวตาราง ช่องกรอก หน้าต่างดูข้อมูลนักศึกษา หน้าอาจารย์ หน้าประกาศ ("ทุกหลักสูตร") · เมนู "จัดการสาขาวิชา" → **"จัดการหลักสูตร"** · "รหัสสาขา" → "รหัสหลักสูตร"
- **ภาคปกติ/ภาคพิเศษ** เดิมเรียก "หลักสูตร" / "ระบบการศึกษา" / "แผนการศึกษา" / "หลักสูตรการศึกษา" → **"รูปแบบการศึกษา"** ทุกหน้า
- **ไฟล์ Excel รายชื่อนักศึกษา**: หัวคอลัมน์ "สาขา" → "หลักสูตร" · "ระบบการศึกษา" → "รูปแบบการศึกษา"
  - ⚠️ ถ้ามีสูตร/ระบบอื่นที่อ้างชื่อหัวคอลัมน์เดิม ต้องปรับตาม
- ข้อความแจ้งผิดพลาดจากระบบ (เช่น "ไม่พบหลักสูตร … — เพิ่มที่เมนูจัดการหลักสูตรก่อน")

### ไม่เปลี่ยน
- หนังสือราชการและแบบฟอร์มทางการ — หนังสือผู้ปกครอง ("หลักสูตร … สาขาวิชา …"), หนังสือนิเทศ/ขอความอนุเคราะห์ ("สาขาวิชาวิทยาการคอมพิวเตอร์"), ช่อง "สาขาวิชา" ใน T000/T003
- หัวคอลัมน์ของไฟล์นำเข้านักศึกษา (มาจากไฟล์ของทะเบียน) · ชื่อฟิลด์ในฐานข้อมูล · ไม่มี migration

### Tests
- ใหม่ `backend/__tests__/terminology.test.js` — ฟ้องถ้าคำเก่ากลับมาในหน้าเว็บ หรือหนังสือราชการถูกแก้ตาม
- unit 725/725 · e2e 97/97 · ตรวจ 48 หน้าไม่มี error · ตรวจป้ายบนหน้าจริง 6 หน้า + ไฟล์ Excel 15/15

## [2026-09-23] feat: รอพิจารณาเกรด · หน้าคำร้องบอกชัดว่าตรวจแล้ว · รอบรับสมัครบน Dashboard นักศึกษา · ลิงก์เอกสารในไฟล์ Excel

### Added
- **สถานะ "รอพิจารณาเกรด"** (หน้าตรวจสอบคำร้องขอสหกิจศึกษา) — ปุ่มใหม่ "📊 รอพิจารณาเกรด" สำหรับคนที่เกรดยังไม่ออก กดได้เลยไม่ต้องใส่หมายเหตุ
  - เกรดออกแล้วกลับมากด ผ่าน / ส่งกลับแก้ไข / ไม่ผ่าน ได้ตามปกติ (ทั้งเจ้าหน้าที่และอาจารย์ที่ปรึกษา)
  - นักศึกษาได้รับแจ้งเตือน และหน้ายื่นคำร้อง/Dashboard บอกว่า "รอพิจารณาเกรด — ไม่ต้องยื่นใหม่" · ยังไปขั้น T000 ไม่ได้
  - ตัวกรอง "รอพิจารณาเกรด" · นับเป็น "รอดำเนินการ" ใน Dashboard เจ้าหน้าที่และอาจารย์ · ไม่ถูกรวมในปุ่มอนุมัติทั้งหมด
  - บันทึกการใช้งาน: "พักคำร้องสหกิจ (รอพิจารณาเกรด)"
  - migration `20260923210000_add_pending_grade_status` (เพิ่มค่าใน enum CoopStatus)
- **Dashboard นักศึกษา** — การ์ด "รอบที่เปิดรับสมัครสหกิจ" แสดงภาคเรียน/ปีการศึกษาที่เปิดรับ, รอบของตัวเอง (ถ้าต่างกัน) และกำหนดยื่นคำร้อง ("ยื่นคำร้องได้ถึง …" / "ปิดรับคำร้องแล้ว")
- **ลิงก์เอกสารในไฟล์ Excel** (ปุ่ม export รายชื่อนักศึกษาที่ Dashboard เจ้าหน้าที่ และของอาจารย์)
  - ชีต "นักศึกษา" เพิ่มคอลัมน์ไฟล์ 11 ชนิด (Transcript, CV, บัตรนักศึกษา, บัตรประชาชน, ใบยินยอมผู้ปกครอง, T000, หนังสือขอความอนุเคราะห์, ใบตอบรับ, หนังสือส่งตัว, T002, T003) — ไฟล์ล่าสุดของแต่ละชนิด กดเปิดได้
  - ชีตใหม่ "เอกสารทั้งหมด" — ทุกไฟล์ 1 แถว พร้อมสถานะและวันที่อัปโหลด (ชนิดที่มีหลายไฟล์ เช่น เอกสารแนบคำร้อง ไม่ตกหล่น · เอกสารที่เจ้าหน้าที่เพิ่มเองใช้ชื่อจากหน้าตั้งค่าเอกสาร)
  - ลิงก์เป็นแบบเต็ม `https://coop.computing.kku.ac.th/uploads/...` (ใช้โดเมนของหน้าที่กด export หรือ `PUBLIC_BASE_URL` ถ้าตั้งไว้) · เปิดได้โดยไม่ต้องเข้าสู่ระบบ ตามที่ตกลง (ต้องอยู่ในเครือข่าย มข./VPN)

### Changed
- **หน้าตรวจสอบคำร้องขอสหกิจศึกษา** — คำร้องที่ตรวจผ่านแล้วแสดง "✅ ตรวจแล้ว · ผ่านเกณฑ์" พร้อม "ขั้นตอนตอนนี้: …" และปุ่มเป็น "ดูคำร้อง" (เดิมแสดงสถานะปัจจุบันของนักศึกษา เช่น "รอตรวจเอกสาร" ดูเหมือนคำร้องยังไม่ได้ตรวจ)
  - ตัวกรอง "รอดำเนินการ" เหลือเฉพาะคำร้องที่ยังไม่ได้ตรวจ (เดิมรวมคนที่ผ่านแล้วและรอตรวจ T000) · "ผ่านเกณฑ์แล้ว" รวมทุกคนที่ผ่านไม่ว่าอยู่ขั้นไหน · เพิ่มตัวกรอง "ไม่ผ่าน"

### Tests
- unit 722/722 · e2e 97/97 · ตรวจ 48 หน้าไม่มี error · ทดสอบในเบราว์เซอร์ 15/15 (กดรอพิจารณาเกรด → แจ้งเตือน → ตัวกรอง → กดผ่าน, ไฟล์ export 2 ชีต ลิงก์เปิดได้, การ์ดรอบรับสมัคร)

## [2026-09-23] feat: มาตรฐานการแจ้งเตือนทั้งระบบ · ยืนยันก่อนอัปโหลดเอกสาร T000

### Changed
- **เลิกใช้กล่อง alert / confirm / prompt ของเบราว์เซอร์ทั้งหมด** (alert 203 จุด, confirm 39 จุด, prompt 1 จุด ใน 44 ไฟล์) แล้วเปลี่ยนเป็นมาตรฐานเดียว:
  - **ผลของปุ่มที่เพิ่งกด** → toast มุมขวาบน แยกสีตามประเภท (สำเร็จ / ผิดพลาด / คำเตือน / ข้อมูล)
  - **ถามก่อนทำสิ่งที่ย้อนไม่ได้** → กล่องยืนยันของระบบ ปุ่มบอกชัดว่าจะทำอะไร ("ลบไฟล์", "ย้ายไปถังขยะ", "ตีกลับ" ฯลฯ) และปุ่มสีแดงถ้าเป็นการลบหรือตีกลับ
  - เหตุผล: Chrome ให้ผู้ใช้ติ๊ก "ไม่ให้หน้านี้สร้างกล่องโต้ตอบเพิ่ม" ได้ ถ้าติ๊กไว้ confirm จะตอบ "ไม่" ทุกครั้ง ปุ่มลบ/ส่งจะกดแล้วเงียบไปเลย · alert ยังขวางทั้งหน้า และบนมือถือดูเหมือนข้อความจากระบบ
- **Toast**: ข้อความผิดพลาดค้าง 8 วินาที คำเตือน 6 วินาที สำเร็จ 4 วินาที (เดิมหายใน 4 วินาทีทุกแบบ อ่านสาเหตุไม่ทัน) · ข้อความเดิมซ้ำ (กดปุ่มซ้ำ) ไม่ซ้อนกัน · แสดงพร้อมกันไม่เกิน 3 อัน · ลอยเหนือหน้าต่าง modal (เดิมถูก modal บัง)
- **กล่องยืนยัน**: โฟกัสอยู่ที่ปุ่ม "ยกเลิก" เมื่อเปิด (กด Enter พลาดจะไม่ลบ) · Esc / คลิกนอกกล่อง = ยกเลิก · แสดงข้อความหลายบรรทัดได้
- **เซสชันหมดอายุ**: ไม่เด้ง alert ซ้อนหลายกล่องเมื่อคำขอหลายตัวหมดอายุพร้อมกันอีกแล้ว — พากลับหน้าเข้าสู่ระบบแล้วแสดงคำเตือนครั้งเดียว
- **ส่ง T002 / T003**: ข้อความ "อัปโหลดแล้ว รอการตรวจ" แสดงหลังหน้ารีโหลด (เดิม alert ค้างหน้าไว้จนกด OK)
- **ประกาศ**: เพิ่มลิงก์ผ่านช่องกรอกในฟอร์ม (เดิมเป็น prompt) ข้อความ URL ผิดแสดงใต้ช่อง · บันทึกประกาศแล้วขึ้นข้อความสำเร็จ และแจ้งเมื่อบันทึกไม่สำเร็จ (เดิมเงียบทั้งสองกรณี)
- ข้อความภาษาอังกฤษ ("Connection Error", "PDF Error: ตรวจสอบ Console", "Error uploading file") เปลี่ยนเป็นภาษาไทยที่บอกสาเหตุและวิธีแก้

### Added
- **ยืนยันก่อนอัปโหลดเอกสาร T000** (หน้าอัปโหลดเอกสารประกอบการสมัคร) — เลือกไฟล์แล้วยังไม่อัปโหลดทันที ขึ้นชื่อไฟล์และขนาดให้ตรวจก่อน พร้อมปุ่ม "ยกเลิก" / "ยืนยันส่งไฟล์" แบบเดียวกับ T002/T003
- `Frontend/src/utils/notify.ts` — `notify.success/error/warning/info()`, `askConfirm()` และ `notify.afterReload()` เรียกได้จากทุกที่ รวมไฟล์ utils ที่ไม่ใช่ component
- ตัวกันหลุด: ESLint `no-alert` และเทสต์ `backend/__tests__/noNativeDialogs.test.js` ฟ้องถ้ามีคนเพิ่ม alert / confirm / prompt กลับมา

### Fixed
- ลบไฟล์ในตารางเอกสาร T000 ถามยืนยันสองรอบ — เหลือรอบเดียว

### Tests
- e2e `coop-lifecycle`: เปลี่ยนจากกด OK ใน dialog ของเบราว์เซอร์ เป็นกดปุ่มยืนยันในกล่องของระบบ
- ผ่าน: unit 716/716 · e2e 97/97 · ตรวจ 48 หน้าไม่มี error · tsc คงที่ที่ 24 error เดิม · vite build ผ่าน

## [2026-09-23] feat: รูปถ่ายในใบสมัคร T000 · ที่อยู่บริษัทในหนังสือผู้ปกครอง

### Added
- **รูปถ่ายในใบสมัคร T000** — หน้าเอกสารสหกิจ ส่วน "ข้อมูลการสมัคร" มีช่องอัปโหลดรูปถ่าย พร้อมตัวอย่างและปุ่มเปลี่ยน/ลบรูป
  - PDF ใบสมัครวาดรูปลงกรอบรูปถ่ายมุมขวาบนให้เลย ไม่ต้องพิมพ์ออกไปแปะรูปเอง (ไม่มีรูปก็แสดงกรอบว่างพร้อมข้อความเดิม)
  - เบราว์เซอร์ครอปกึ่งกลางเป็นสัดส่วนรูปติดบัตร 5:6 และย่อเหลือ 600×720 ก่อนอัปโหลด — รูปจากมือถือหลาย MB เหลือราว 10–100 KB, PDF ไม่บวม, รูปไม่บิดในกรอบ
  - หลังบ้านรับเฉพาะ JPG/PNG ไม่เกิน 5 MB · เปลี่ยนรูปแล้วลบไฟล์เก่าทิ้ง ไม่ให้ไฟล์ค้าง
  - บันทึกการใช้งาน: "อัปโหลดรูปถ่ายใบสมัคร (T000)" / "ลบรูปถ่ายใบสมัคร (T000)" (อยู่ในตัวกรองเรื่องเอกสาร)
- **หนังสือผู้ปกครอง** — ต่อที่อยู่บริษัทหลังชื่อบริษัท: "…ณ สถานประกอบการที่ <ชื่อบริษัท> ตั้งอยู่ที่ <ที่อยู่>" ประกอบจากช่องที่อยู่ของบริษัท (รูปแบบเดียวกับที่อยู่อื่นในระบบ) · บริษัทเก่าที่มีแต่ที่อยู่แบบข้อความรวมก็ใช้ข้อความนั้น · ไม่มีที่อยู่เลยเว้นเส้นจุดไว้เขียนมือ

### Database
- migration `20260923190000_add_form_photo` — `CoopApplicationForm.photoPath` (ไม่แตะข้อมูลเดิม)
- API: `POST /api/docs/form-photo` (field `photo`) · `DELETE /api/docs/form-photo` (นักศึกษา)

### Verified
- เบราว์เซอร์ + อ่าน PDF จริงด้วย pdf.js 7/7: อัปโหลดรูปแนวนอนแล้วถูกครอปเป็น 600×720 · PDF ใบสมัครมีรูปฝังอยู่และไม่มีข้อความ "Recent of Applicant" ค้าง · ดูภาพหน้า PDF แล้วรูปอยู่กลางกรอบไม่บิด · หนังสือผู้ปกครองมีชื่อบริษัทตามด้วย "ตั้งอยู่ที่ …" · ไม่มี JS error · คืนข้อมูลนักศึกษาที่ใช้ทดสอบกลับค่าเดิม
- unit tests 714/714 (เทสต์กันหลุดจับได้ว่าชื่อการกระทำใหม่ยังไม่อยู่ในตัวกรองเอกสาร — แก้แล้ว) · tsc 24 error เดิม · vite build ผ่าน · e2e 97/97 · เปิดทุกหน้า 48 หน้าไม่มีปัญหา

## [2026-09-23] feat(นิเทศ): ไฟล์ export ตารางนิเทศมีลิงก์นิเทศออนไลน์

### Added
- คอลัมน์ **"ลิงก์นิเทศ (ออนไลน์)"** ต่อจากคอลัมน์รูปแบบ · กดเปิดได้ใน Excel
- นิเทศออนไซต์แสดง "-" (แม้จะมีลิงก์ค้างจากตอนเสนอวันแบบออนไลน์) · ออนไลน์ที่ยังไม่มีลิงก์แสดง "-"
- ทำเป็นลิงก์ให้กดเฉพาะ http/https เท่านั้น

### Verified
- unit tests ใหม่ 6 ข้อ (เดิมไม่มีเทสต์ของไฟล์นี้) · ดาวน์โหลดจากระบบจริง 6/6: ลิงก์ตรงฐานข้อมูล กดได้ แถวออนไซต์เป็น "-" · คืนข้อมูลนัดที่ใช้ทดสอบกลับค่าเดิม

## [2026-09-23] feat: ช่วงเวลายื่นคำร้องสหกิจ ตั้งแยกได้แบบเดียวกับ T000–T003

### Added
- หน้า **ตรวจสอบคำร้องสหกิจ** มีกล่อง "⚙️ จัดการเวลายื่นคำร้องสหกิจ" (วันเปิดรับ · วันปิดรับ · สวิตช์เปิดระบบ · สถานะปัจจุบัน) หน้าตาเดียวกับกล่องตั้งเวลา T000–T003
- **นักศึกษายื่นได้ต้องผ่านทั้งสองอย่าง:** รอบรับสมัครเปิดอยู่ (ไว้ผูกคำร้องกับรอบ) และอยู่ในช่วงเวลายื่นคำร้องนี้
- หน้ายื่นคำร้องบอกเหตุผลที่ปิดพร้อมช่วงวัน เช่น "ปิดรับคำร้องแล้ว (ช่วงยื่นคำร้อง 1 ต.ค. 2569 ถึง 15 ต.ค. 2569)" · ตอนเปิดแสดงช่วงยื่นคำร้องแทนวันของรอบ
- Dashboard นักศึกษาแสดงคำร้องในรายการที่กำลังเปิดรับ พร้อมนับถอยหลังเหมือน T000–T003
- การตั้งค่าถูกบันทึกลงบันทึกการใช้งาน "ตั้งค่าช่วงเวลายื่นคำร้องสหกิจ"

### ทำงานอย่างไร
- SystemConfig `APPLY_CONFIG` { startDate, endDate, isOpen } · `utils/applyWindow.js`
- **ยังไม่เคยตั้งค่า = เปิดตามรอบรับสมัครเหมือนเดิม** — deploy แล้วไม่มีใครโดนปิดกั้นทันที
- ตีความวันที่เป็นเวลาไทยเสมอ (00:00 ของวันเปิด ถึง 23:59 ของวันปิด) · สถานะตัดสินที่ server แล้วส่งให้หน้าเว็บแสดง จะได้ตรงกับที่บังคับจริง
- บังคับที่ server ด้วย — ยิง API ตรงๆ ตอนปิดได้ 400 พร้อมเหตุผล ไฟล์ที่แนบมาถูกลบทิ้ง
- แก้ค่าได้เฉพาะเจ้าหน้าที่ (อาจารย์อ่านได้อย่างเดียว) · ตรวจวันเปิดไม่อยู่หลังวันปิด

### หมายเหตุ
- ช่วงปิดจะกันการ "ส่งแก้ไขคำร้อง" ด้วย เหมือนที่ T000–T003 กันการส่งเอกสารนอกช่วง — ถ้าตีกลับคำร้องหลังปิดช่วงแล้ว ต้องเปิดช่วงให้นักศึกษาส่งแก้

### Verified
- unit tests 714/714 (ใหม่ 10: ยังไม่ตั้งค่า=เปิด · ขอบวันตามเวลาไทย · ปิดสวิตช์ · ไม่กรอกวันฝั่งเดียว · ข้อความไทย · ค่าเสีย · อ่าน/บันทึก/ตรวจวันผิด · ชื่อใน log)
- เบราว์เซอร์ + API จริง 11/11: เจ้าหน้าที่ตั้งเวลาแล้วสถานะขึ้นตาม server · ตั้งวันเปิดหลังวันปิดโดนเตือน · นักศึกษาเห็นป้ายปิดพร้อมช่วงวัน · ยิง API ตรงโดนปฏิเสธ ไม่มีคำร้องถูกสร้าง · อาจารย์แก้ไม่ได้ (403) · Dashboard นักศึกษาแสดงคำร้อง · คืนการตั้งค่ากลับเป็นยังไม่ตั้งค่า
- tsc 24 error เดิม · vite build ผ่าน · e2e 97/97 · regression 66/66 · เปิดทุกหน้า 48 หน้าไม่มีปัญหา

## [2026-09-23] feat: ช่องกรอกที่อยู่แยกเป็นช่องย่อย (ใบสมัคร T000 และแบบฟอร์ม T002)

เดิมที่อยู่เป็นกล่องข้อความเดียว นักศึกษาพิมพ์กันคนละแบบ บางคนไม่ใส่รหัสไปรษณีย์ บางคนไม่ใส่จังหวัด

### Changed
- ที่อยู่ 4 ชุดเปลี่ยนเป็นช่องแยก: **บ้านเลขที่ · หมู่ · ซอย · ถนน · ตำบล/แขวง · อำเภอ/เขต · จังหวัด · รหัสไปรษณีย์** (ช่องที่มี * คือช่องหลัก)
  - ใบสมัคร T000: ที่อยู่ติดต่อของนักศึกษา · ที่อยู่ผู้ปกครอง (ติดต่อฉุกเฉิน)
  - แบบฟอร์ม T002: ที่พักระหว่างฝึก · ที่อยู่กรณีฉุกเฉิน
- ใต้ช่องมีตัวอย่าง "ที่อยู่ที่จะถูกนำไปใช้ในเอกสาร" อัปเดตทันทีที่พิมพ์ รูปแบบเดียวกับที่อยู่บริษัท (กรุงเทพฯ ใช้ แขวง/เขต · จังหวัดอื่นใช้ ต./อ./จ.)
- **ข้อมูลเดิมไม่หาย** — คนที่เคยพิมพ์ที่อยู่แบบกล่องเดียวไว้ จะเห็นที่อยู่เดิมแสดงด้านบนพร้อมข้อความให้กรอกลงช่องใหม่ · เอกสาร PDF ยังใช้ที่อยู่เดิมจนกว่าจะกรอกช่องใหม่
- ช่องไม่ได้บังคับกรอกตอนบันทึก — กรอกค้างไว้แล้วกลับมาทำต่อได้เหมือนเดิม

### ทำงานอย่างไร
- เก็บทั้งช่องย่อย (คอลัมน์ใหม่ 32 คอลัมน์ นำหน้าด้วย `contact` `emer` `accom`) และข้อความรวมในคอลัมน์เดิม (`contactAddress` `emergencyAddress` `accommodationAddress`) ที่ PDF และหน้าจออื่นอ่านอยู่แล้ว
- ข้อความรวม **ฝั่ง server ประกอบให้เสมอ** ตอนบันทึก (`utils/addressFormat.js`) ไม่ต้องหวังว่าหน้าเว็บส่งมาถูก · หน้าเว็บก็ประกอบทันทีที่พิมพ์ด้วย เพราะ PDF สร้างจากฝั่งเบราว์เซอร์ — ผู้ใช้ที่กดสร้าง PDF ก่อนบันทึกจะได้ที่อยู่ใหม่
- migration `20260923160000_split_address_fields` (เพิ่มคอลัมน์ ไม่แตะข้อมูลเดิม)

### Verified
- unit tests 698/698 (ใหม่ 9: ต่างจังหวัด/กรุงเทพฯ · ช่องว่างไม่ทิ้งช่องว่างค้าง · ข้อมูลเก่าที่ไม่มีช่องย่อยยังบันทึกได้ · ล้างที่อยู่ · ที่อยู่คนละชุดในฟอร์มเดียวไม่ปนกัน)
- API + เบราว์เซอร์จริง 12/12: บันทึกแยกช่องทั้ง T000/T002 · ข้อความรวมถูกรูปแบบ · ไม่มีกล่องแบบเดิมแล้ว · มีครบ 8 ช่อง · ค่าที่บันทึกไว้โหลดกลับเข้าช่อง · ตัวอย่างที่อยู่อัปเดตทันที · ยังไม่กดบันทึกก็ได้ที่อยู่ใหม่ในเอกสาร · คืนข้อมูลนักศึกษาทดสอบกลับค่าเดิม
- tsc 24 error เดิม · vite build ผ่าน · e2e 97/97 · regression 66/66 · เปิดทุกหน้า 48 หน้าไม่มีปัญหา
...
### Removed
- การ์ด "🎯 คำขอพิจารณากรณีพิเศษ" บนหน้า Dashboard เจ้าหน้าที่ — ไม่ได้ใช้งานจริง และหลังบ้านส่งค่าเป็น 0 ตายตัวมาตลอด (`const specialRequests = 0`)
- `specialRequests` ออกจาก response ของ `/api/admin/dashboard-stats` และจาก type ฝั่งหน้าเว็บ

### Verified
- unit tests 689/689 · tsc 24 error เดิม · vite build ผ่าน · e2e 97/97
- เบราว์เซอร์ 6/6: API ไม่ส่งฟิลด์นี้แล้วแต่ตัวเลขอื่นครบ · การ์ดหายจากหน้าจอ · การ์ดที่เหลือ (นักศึกษาในระบบ ยื่นสหกิจแล้ว ข่าวประกาศ บันทึกรายงาน รอดำเนินการ อนุมัติผ่านแล้ว ไม่ผ่าน/แก้ไข) ยังอยู่ครบ · ไม่มี JS error
