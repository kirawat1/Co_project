...
const RULES = [
  ...
  ['POST', '/api/docs/form-photo', 'อัปโหลดรูปถ่ายใบสมัคร (T000)', 'นักศึกษา', null],
  ['DELETE', '/api/docs/form-photo', 'ลบรูปถ่ายใบสมัคร (T000)', 'นักศึกษา', null],
...
const DOC_ACTION_PREFIXES = [
  ...
  'อัปโหลดเอกสาร', 'ลบเอกสาร', 'ดาวน์โหลดหนังสือ', 'รับทราบหนังสือ', 'ส่งแบบฟอร์ม', 'บันทึกแบบฟอร์ม', 'อัปโหลดรูปถ่าย', 'ลบรูปถ่าย',
];
